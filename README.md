...
* Un entorno de desarrollo completo que proporciona todo lo necesario para compilar, flashear, depurar y programar los microcontroladores.
* Soporte de lenguaje, ESP-IDF permite el desarrollo de código en C y C++
* Está basado en FreeRTOS, es decir su programación se basa en el sistema operativo en tiempo real, lo que permite una gestión eficiente de tareas y recursos.
* Soporte completo para  TCP/IP, Wi-Fi, Bluetooh, etc.
